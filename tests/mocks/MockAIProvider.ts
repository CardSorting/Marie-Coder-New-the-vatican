import { AIProvider, AIRequestParams, AIStreamEvent, AIResponse } from '../../src/monolith/infrastructure/ai/providers/AIProvider.js';
...
export class MockAIProvider implements AIProvider {
    ...
    public async createMessageStream(options: AIRequestParams, onUpdate: (event: AIStreamEvent) => void, signal?: AbortSignal): Promise<AIResponse> {
